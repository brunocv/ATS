...
import java.util.logging.Level;import java.util.logging.Logger; import java.util.InputMismatchException;
...
public class mPrincipal implements Serializable {
  ...
  private transient Logger logger = Logger.getLogger(this.getClass().getName());  /* STARTING functions */
  ...
  public String leString() {
    ...
    try {
      ...
      logger.log(Level.WARNING,"Não foi detetado nenhum input compatível com o pedido.");
    }
